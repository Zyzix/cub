...
(function() {
    if (!requirejs.defined('da676/df0c1/b4fa4'))
        return API.chatLog('This version of plug&#179; is not compatible with this version of plug.dj', false), true;
    ...
    define('f82fae/d67453/a1ab3a', ['jquery', 'da676/df0c1/b4fa4', 'lang/Lang', 'da676/df0c1/fe7d6', 'f82fae/f1da31'], function($, b, c, d, p3Lang) {
    ...
    define('f82fae/d67453/f0dff5', ['jquery', 'da676/a5d9e/d6ba6/f53a8', 'lang/Lang', 'da676/df0c1/b4fa4', 'da676/df0c1/fe7d6', 'da676/ae6e4/a99ef', 'f82fae/f1da31'], function($, b, c, d, e, f, p3Lang) {
        var a = d.extend({
            init: function(id) {
    ...
    define('f82fae/d67453/c8e8fc', ['jquery', 'da676/df0c1/b4fa4', 'lang/Lang', 'f82fae/f1da31', 'f82fae/ac606c'], function($, b, c, p3Lang, p3Utils) {
        var userCommands = [
    ...
    define('f82fae/a07c86', ['jquery', 'da676/df0c1/b4fa4'], function($, Class) {
        var obj,
            styles = {},
            update = function() {
                var a = '';
    ...
    define('f82fae/ac606c', ['da676/df0c1/b4fa4', 'da676/a5d9e/a7e5a/f7efa/bf595', 'f82fae/f1da31'], function(Class, PopoutView, p3Lang) {
    ...
    define('f82fae/f36e0e', ['jquery', 'da676/a5d9e/a7e5a/e6458/d5e18', 'f82fae/f1da31', 'f82fae/ac606c', 'da676/df0c1/fe7d6'], function($, RoomUserListRow, p3Lang, p3Utils, Context) {
    ...
    define('f82fae/f1da31', ['jquery', 'da676/df0c1/b4fa4'], function($, Class) {
        var language = {},
            isLoaded = false,
            Lang = Class.extend({
                init: function() {
    ...
    define('f82fae/a8c196', ['jquery', 'da676/df0c1/b4fa4'], function($, Class) {
        return Class.extend({
    ...
    define('f82fae/e78de6', ['jquery', 'da676/df0c1/b4fa4', 'f82fae/b93191', 'da676/a5d9e/d6ba6/f53a8', 'f82fae/f1da31', 'f82fae/ac606c'], function($, Class, Model, ADV, p3Lang, p3Utils) {
    ...
    */
    define('f82fae/abd868', ['jquery', 'underscore', 'da676/a5d9e/a7e5a/f8aa3/b9700', 'da676/cba08/adf46', 'hbs!templates/room/playback/Volume', 'da676/df0c1/fe7d6', 'f82fae/f1da31'], function($, e, original, r, s, Context, p3Lang) {
